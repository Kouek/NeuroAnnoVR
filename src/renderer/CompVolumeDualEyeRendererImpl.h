#ifndef KOUEK_COMP_VOLUME_DUAL_EYE_RENDERER_IMPL_H
#define KOUEK_COMP_VOLUME_DUAL_EYE_RENDERER_IMPL_H
...
namespace kouek
{
	namespace CompVolumeDualEyeRendererImplCUDA
	{
	...
	class CompVolumeDualEyeRendererImpl : public CompVolumeDualEyeRenderer
	{
	private:
		CUDAParameter cuda;
		bool subrgnChanged = true;
		CompVolumeDualEyeRendererImplCUDA::CompVolumeParameter compVolumeParam;
		CompVolumeDualEyeRendererImplCUDA::RenderParameter renderParam;
	...
	public:
		CompVolumeDualEyeRendererImpl(const CUDAParameter& cudaParam);
		~CompVolumeDualEyeRendererImpl();
...
#endif // !KOUEK_COMP_VOLUME_DUAL_EYE_RENDERER_IMPL_H
